<?php
session_start();
require_once 'C:\xampp\htdocs\OVS\admin/upElectionDb.php';
?>
<!DOCTYPE html>
<html>
<head>
...
var optionArray = ["|","East Garo Hills| East Garo Hills"," East Khasi Hills| East Khasi Hills","East Jaintia Hills| East Jaintia Hills","North Garo Hills| North Garo Hills","Ri Bhoi| Ri Bhoi","South Garo Hills| South Garo Hills","South West Garo Hills| South West Garo Hills","South West Khasi Hills| South West Khasi Hills","West Jaintia Hills| West Jaintia Hills","West Garo Hills| West Garo Hills","West Khasi Hills| West Khasi Hills"];
}else if(s1.value == "mizoram"){
var optionArray = ["|","Aizawl| Aizawl","Champhai| Champhai","Kolasib| Kolasib","Lawngtlai| Lawngtlai","Lunglei| Lunglei","Mamit| Mamit","Saiha| Saiha","Serchhip | Serchhip"];
...
var optionArray = ["|","Dhalai| Dhalai","Gomati| Gomati","Khowail| Khowail","North Tripura | North Tripura","Sepahijalal | Sepahijalal","South Tripura | South Tripura","Unokotil | Unokotil","West Tripura | West Tripura"];
...
<center>
	<div class = "container">
	<form action="StateLegislativeAssembly.php" method="POST">
...
<p>
<label>State:</label>
<select id="slct1" name="state" onchange="populate(this.id,'slct2')" style="width: 17%; border-radius: .20em;" required>
