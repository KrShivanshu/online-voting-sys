<?php
   ...
   require_once 'statusconfirm.php';
   //$user = $_SESSION['user'];
   ...
   $placeQuery ="SELECT * from voters where verified = 0";
...
<center><h2>Verify Voter</h2></center>
<?php
  ...
  <div class ="container">
   ...
   <p>
      ...
      <td><?php echo $voter['state'] ?></td>
			<td>
        <button class="table-danger"  type="submit" name="btn" value="reject" form="stat" formaction="verifyvoter.php">Reject</button>
        <button class="table-danger" type="submit" name="btn" value="accept" form="stat" formaction="verifyvoter.php">Accept</button>
    </p>  
      </td>
		</tr>
		<?php 
