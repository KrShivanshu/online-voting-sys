...
var optionArray = ["|------------select------------","Nicobar| Nicobar","North and Middie Andaman| North and Middle Andaman","South Andaman| South Andaman"];
} else if(s1.value == "andhra-pradesh"){
var optionArray = ["|------------select------------","Anantapur|Anantapur","Chittoor|Chittoor","EastGodavari|East Godavari ","Guntur|Guntur","Kadapa|Kadapa","Krishna|Krishna ","Kumool|Kumool","Prakasam|Prakasam ","Nellore|Nellore","Srikakulam|Srikakulam","Visakhapatnam|Visakhapatnam","Vizianagaram|Vizianagaram","WestGodavari|West Godavari"];
}else if(s1.value == "arunachal-pradesh"){
var optionArray = ["|------------select------------","Anjaw | Anjaw","Changlang | Changlang ","East Kameng East | Kameng ","East Siang | East Siang ","Kamle | Kamle ","Kra Daadi | Kra Daadi ","Kurung Kumey | Kurung Kumey ","Lepa-Rada | Lepa-Rada ","Lohit | Lohit ","Longding | Longding ","Lower Dibang Valley | Lower Dibang Valley ","Lower Siang | Lower Siang ","Lower Subansiri | Lower Subansiri ","Namsai | Namsai ","Pakke-Kessang | Pakke-Kessang ","Papum Pare | Papum Pare ","Shi Yomi | Shi Yomi ","Siang |	Siang ","Tawang | Tawang ","Tirap | Tirap ","Upper Dibang Valley | Upper Dibang Valley ","Upper Siang | Upper Siang ","Upper Subansiri | Upper Subansiri ","West Kameng | West Kameng ","West Siang | West Siang"];
} else if(s1.value == "assam"){
var optionArray = ["|------------select------------","Baksa| Baksa","Barpeta| Barpeta","Bishwanath| Bishwanath","Bongaigaon| Bongaigaon","Cachar| Cachar","Charaideo| Charaideo","Chirang| Chirang","Darrang| Darrang","Dhemaji| Dhemaji","Dhubri| Dhubri","Dibrugarh| Dibrugarh","Dima Hasao| Dima Hasao","Goalpara| Goalpara","Golaghat| Golaghat","Hailakandi| Hailakandi","Hojai| Hojai","Jorhat| Jorhat","Kamrup| KamrupKamrup Metropolitan| Kamrup Metropolitan","Karbi Anglong| Karbi Anglong","Karimganj| Karimganj","Kokrajhar| Kokrajhar","Lakhimpur| Lakhimpur","Majuli| Majuli","Morigaon| Morigaon","Nagaon| Nagaon","Nalbari| Nalbari","Sivasagar| Sivasagar","South| Salmara","South| Salmara","Sonitpur | Sonitpur","Tinsukia| Tinsukia","Udaiguri| Udaiguri","West Karbi Anglong| West Karbi Anglong"];
}else if(s1.value == "bihar"){
var optionArray = ["|------------select------------","Araria|Araria ","Arwal|Arwal ","Aurangabad| Aurangabad ","Banka|Banka ","Begusarai| Begusarai ","Bhagalpur| Bhagalpur ","Bhojpur| Bhojpur ","Buxar| Buxar ","Danang|Danang ","East Champaran | East Champaran ","Gaya|Gaya ","Gopalganj| Gopalganj ","Jamui|Jamui ","Jehanabad|Jehanabad ","Kaimur|Kaimur ","Katihar|Katihar ","Khagaria|Khagaria "," Kishanganj| Kishanganj "," Lakhisarai|LakhisaraiMadhepura|Madhepura ","Madhubani|Madhubani ","Munger|Munger ","Muzaffarpur|Muzaffarpur ","Nalanda|Nalanda ","Nawada|Nawada ","Patna|Patna ","Purnia|Purnia ","Rohtas|Rohtas ","Saharsa|Saharsa ","Samastipur|Samastipur ","Saran|Saran ","Sheikhpura| Sheikhpura ","Sheohar| Sheohar ","Sitamarhi| Sitamarhi ","Siwan|Siwan ","Supaul|Supau ","Vaishali|Vaishali ","West Champaran| West Champaran"];
}else if(s1.value == "chandigarh"){
var optionArray = ["|------------select------------","Chandigarh|Chandigarh"];
}else if(s1.value == "chhattisgarh"){
var optionArray = ["|------------select------------","Balod| Balod","Baloda Bazar | Baloda Bazar","Balrampur | Balrampur","Bastar| Bastar","Bemetara| Bemetara","Bijapur | Bijapur","Bilaspur | Bilaspur","Dantewada | Dantewada","Dhamtari | Dhamtari","Durg | Durg","Gariaband | Garriaband","Janigir-Champa | Janjgir-Champa ","Jashpur | Jashpur ","Kabirdham | Kabirdham ","Kanker| Kanker ","Kondagaon | Kondagaon ","Korba | Korba","Korea |Korea ","Mahasamund | Mahasamund ","Mungeli | Mungeli ","Narayanpur | Narayanpur ","Raigarh | Raigarh ","Raipur | Raipur ","Rajnandgaon | Rajnandgaon ","Sukma | Sukma ","Surajpur | Surajpur ","Surguja | Surguja"];

}else if(s1.value == "dadra-and-nagar-haveli"){
var optionArray = ["|------------select------------","Dadra and Nagar Haveli|Dadra and Nagar Haveli"];
}else if(s1.value == "daman-and-diu"){
var optionArray = ["|------------select------------","Daman|Daman","Diu|Diu"];
}else if(s1.value == "goa"){
var optionArray = ["|------------select------------","North Goa|North Goa ","South Goa|South Goa"];
}else if(s1.value == "gujarat"){
var optionArray = ["|------------select------------","Ahmedabad| Ahmedabad ","Amreli| Amreli ","Anand| Anand ","Aravalli| Aravalli ","Banaskantha| Banaskantha ","Bharuch| Bharuch ","Bhavnagar| Bhavnagar ","Botad| Botad ","Chhota Udepur| Chhota Udepur ","Dahod| Dahod ","Dang| Dang ","Devbhoomi Dwarka | Devbhoomi Dwarka ","Gandhinagar| Gandhinagar ","Gir Somnath| Gir Somnath ","Jamnagar| Jamnagar ","Junagadh| Junagadh ","Kheda| Kheda ","Kutch| Kutch ","Mahisagar| Mahisagar ","Mehsana| Mehsana ","Morbi| Morbi ","Narmada| Narmada ","Navsari| Navsari ","Panchmahal| Panchmahal ","Patan| Patan ","Porbandar| Porbandar ","Rajkot| Rajkot ","Sabarkantha| Sabarkantha ","Surat| Surat ","Surendranaga| Surendranagar ","Tapi| Tapi ","Vadodara| Vadodara ","Valsad| Valsad"];
}else if(s1.value == "haryana"){
var optionArray = ["|select all","Ambala| Ambala ","Bhiwani | Bhiwani ","Charkhi Dadri | Charkhi Dadri ","Faridabad| Faridabad ","Fatehabad| Fatehabad "," Gurugram| Gurugram ","Hissar | Hissar ","Jhajjar| Jhajjar ","Jind| Jind ","Kaithal| Kaithal ","Karnal | Karnal ","Kurukshetra| Kurukshetra ","Mahendragarh | Mahendragarh ","Nuh| Nuh ","Palwal| Palwal ","Panchkula| Panchkula ","Panipat| Panipat ","Rewari| Rewari ","Rohtak| Rohtak ","Sirsa| Sirsa ","Sonipat | Sonipat ","Yamuna Nagar| Yamuna Nagar "];
...
var optionArray = ["|------------select------------","Anantnag| Anantnag","Bandipora| Bandipora","Baramulla| Baramulla","Badgam| Badgam","Doda| Doda","Ganderbal| Ganderbal","Jammu| Jammu","Kargil| Kargil","Kathua| Kathua","Kishtwar| Kishtwar","Kulgam| Kulgam","Kupwara| Kupwara","Leh| Leh","Poonch| Poonch","Pulwama| Pulwama","Rajouri| Rajouri","Ramban| Ramban","Reasi| Reasi","Samba| Samba","Shopian| Shopian","Srinagar| Srinagar","Udhampur| Udhampur"];
...
var optionArray = ["|------------select------------","Bagalkot| Bagalkot","Ballari| Ballari ","Belagavi| Belagavi "," Bengaluru Rural| Bengaluru Rural ","Bengaluru Urban| Bengaluru Urban ","Bidar| Bidar "," Chamarajnagar| Chamarajnagar ", "Chikkaballapur| Chikkaballapur","Chikkamagaluru| Chikkamagaluru ","Chitradurga| Chitradurga ","Dakshina Kannada| Dakshina Kannada ","Davanagere| Davanagere ","Dharwad |Dharwad ","Gadag |Gadag ","Hassan |Hassan ","Haveri| Haveri ","Kalaburagi| Kalaburagi ","Kodagu |Kodagu ","Kolar| Kolar ","Koppal| Koppal ","Mandya |Mandya","Mysuru|Mysuru "," Raichur| Raichur ","Ramanagara| Ramanagara ","Shivamogga| Shivamogga ","Tumakuru| Tumakuru ","Udupi| Udupi ","Uttara Kannada| Uttara Kannada ","Vijayapura| Vijayapura ","Yadgir| Yadgir"];
...
var optionArray = ["|------------select------------","East Garo Hills| East Garo Hills"," East Khasi Hills| East Khasi Hills","East Jaintia Hills| East Jaintia Hills","North Garo Hills| North Garo Hills","Ri Bhoi| Ri Bhoi","South Garo Hills| South Garo Hills","South West Garo Hills| South West Garo Hills","South West Khasi Hills| South West Khasi Hills","West Jaintia Hills| West Jaintia Hills","West Garo Hills| West Garo Hills","West Khasi Hills| West Khasi Hills"];
...
var optionArray = ["|------------select------------","Dimapur| Dimapur","Kiphire | Kiphire","Kohima Kohima","Longleng | Longleng","Mokokchung Mokokchung ","Mon | Mon","Noklak |Noklak","Peren | Peren","Phek| Phek","Tuensang | Tuensang","Wokha Wokha","Zunheboto | Zunheboto"];
}else if(s1.value == "nct-of-elhi"){
var optionArray = ["------------select------------|------------select------------","Central Delhi| Central Delhi","East Delhi| East Delhi","New Delhi| New Delhi","North Delhi| North Delhi","North East Delhi| North East Delhi","North West Delhi| North West Delhi","Shahdara| Shahdara","South Delhi| South Delhi","South East Delhi| South East Delhi","South West Delhi| South West Delhi","West Delhi| West Delhi"];
...
var optionArray = ["|------------select------------","Karaikal| Karaikal","Mahe| Mahe","Pondicherry| Pondicherry","Yanam| Yanam"];
...
<center>
	<h1 style="font-size: 35px;">Oraganise Election</h1>
...
<center>
	<div class = "container">
	<form action="LokSabha.php" method="POST">
    <input type='hidden' name='level' value='<?php echo $_SESSION['level']; ?>'/>
  <input type='hidden' name='sdate' value='<?php echo $_SESSION['sdate']; ?>'/>
  <input type='hidden' name='edate' value='<?php echo $_SESSION['edate']; ?>'/>
<h2>Choose</h2>
<hr />
<p>
<label>State:</label>
	<select id="slct1" name="state" onchange="populate(this.id,'slct2')" style="width: 17%; border-radius: .20em;" >

			<option value="">Select</option>
			<option value="andaman-and-nicobar-islands" notselected="">Andaman & Nicobar Islands</option>
			...
			<option value="chandigarh" notselected="">Chandigarh</option>                                   
			<option value="chhattisgarh" notselected="">Chhattisgarh</option>                                  
			<option value="dadra-and-nagar-haveli" notselected="">Dadra &amp; Nagar Haveli</option> 
			<option value="daman-and-diu" notselected="">Daman &amp; Diu</option>                                    
			...
			<option value="jammu&kashmir" notselected="">Jammu &amp; Kashmir</option>
			...
			<option value="lakshadweep" notselected="">Lakshadweep</option>                                    
			<option value="madhya-pradesh" notselected="">Madhya Pradesh</option>                                    
			<option value="maharashtra" notselected="">Maharashtra</option>                                   
			<option value="meghalaya" notselected="">Meghalaya</option>                                    
			<option value="mizoram" notselected="">Mizoram</option>                                   
			...
			<option value="puducherry" notselected="">Puducherry</option>
			...
			<option value="tripura" notselected="">Tripura</option>                                   
...
<select id="slct2" name="district[]" style="width: 18%; border-radius: .15em;" multiple></select>
</p>
<hr />
